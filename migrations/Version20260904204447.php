 ...
 */
final class Version20260904204447 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trajet CHANGE statut statut VARCHAR(100) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trajet CHANGE statut statut VARCHAR(20) NOT NULL');
