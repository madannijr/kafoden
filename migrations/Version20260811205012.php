 ...
 */
final class Version20260811205012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document_identite CHANGE date_expiration date_expiration DATE DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document_identite CHANGE date_expiration date_expiration DATE NOT NULL');
