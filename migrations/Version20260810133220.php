 ...
 */
final class Version20260810133220 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trajet CHANGE prix prix NUMERIC(10, 0) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trajet CHANGE prix prix NUMERIC(3, 0) NOT NULL');
